...
public class ShopManagementServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		categoryRepository.save(new Category("Play", "Kids Toys"));
		categoryRepository.save(new Category("Electronics", "Electronics devices"));
		categoryRepository.save(new Category("Household", "Household items"));
		categoryRepository.save(new Category("Cloths", "Mens wear"));
